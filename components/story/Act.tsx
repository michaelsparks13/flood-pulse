...
export const Act = forwardRef<HTMLElement, ActProps>(function Act(
  ...
  return (
    <section
      ...
      className="relative flex items-end justify-center pb-40 sm:pb-44 px-5 sm:px-10"
    >
      <div className="max-w-xl w-full bg-panel/70 backdrop-blur-xl rounded-2xl border border-border p-4 sm:p-6">
        {children}
      </div>
    </section>
  );
